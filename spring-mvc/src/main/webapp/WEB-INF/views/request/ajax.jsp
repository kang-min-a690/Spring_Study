...
<body>
	...
	<form action="${ pageContext.request.contextPath }/request/ajax" method="POST"
	      enctype="multipart/form-data"> <!-- 인코딩 타입, 파일 업로드시 필수~ -->
       <table class="board">
           <tr>
           ...
           <tr>
               ...
               <td class="data">
                   <input type="file" name="file" id="file" multiple> <!-- name:파라미터  -->
               </td>
           </tr>
       </table>
   ...
   $('#btn-insert').on('click', function() {
       ...
       for (let i = 0; i < files.length; i++) {
           formData.append('fileList', files[i]) /* 파라미터를 fileList로바꿔야 맵핑됨 */
       }
   ...
   /* 업로드 저장 파일 은 RequestController 에서 지정 */
